...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      ...
      {/* FLOATING WHATSAPP */}
      <a href="https://wa.me/919876543210?text=Hi, I'm interested in your apartments" target="_blank" rel="noopener noreferrer" className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 bg-green-500 hover:bg-green-600 text-white p-3 sm:p-4 rounded-full shadow-xl shadow-green-500/30 hover:scale-110 transition-all">
      ...
      <a href="tel:+919876543210" className="fixed bottom-4 left-4 sm:bottom-6 sm:left-6 z-50 bg-amber-500 hover:bg-amber-600 text-white p-3 sm:p-4 rounded-full shadow-xl shadow-amber-500/30 hover:scale-110 transition-all md:hidden">
