...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
        ...
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-16">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-5">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:shreeraghavendradevelopers001@gmail.com" className="text-amber-600 hover:underline text-sm mt-0.5 block">shreeraghavendradevelopers001@gmail.com</a>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-11 h-11 bg-amber-100 rounded-xl flex items-center justify-center flex-shrink-0">
            ...
            <div className="grid grid-cols-2 gap-3">
              <a href="https://wa.me/9849013465?text=Hi, I'm interested in your apartments" target="_blank" rel="noopener noreferrer" className="bg-green-500 hover:bg-green-600 text-white rounded-xl p-4 text-center transition shadow-lg">
              ...
              <a href="tel:+919849013465" className="bg-amber-500 hover:bg-amber-600 text-white rounded-xl p-4 text-center transition shadow-lg">
      ...
      {/* Floating WhatsApp */}
      <a href="https://wa.me/919849013465" target="_blank" rel="noopener noreferrer" className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 bg-green-500 hover:bg-green-600 text-white p-3 sm:p-4 rounded-full shadow-xl hover:scale-110 transition-all">
