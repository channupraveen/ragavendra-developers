          ...
          <div className="lg:col-span-2 space-y-10 sm:space-y-14">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6">
                {[
                  ...
                  <div key={d.label} className="bg-gray-50 rounded-xl p-4">
                    <div className="text-xs text-gray-400 uppercase tracking-wide mb-1">{d.label}</div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {project.amenities.map((a: string) => (
                  <div key={a} className="flex items-center gap-2.5 bg-amber-50 rounded-xl px-4 py-3">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-gray-900 text-white">
                      <th className="text-left px-4 sm:px-6 py-3 rounded-tl-xl font-semibold">Configuration</th>
                      <th className="text-right px-4 sm:px-6 py-3 rounded-tr-xl font-semibold">Price*</th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            <div>
              ...
              <div className="rounded-2xl overflow-hidden shadow-lg">
                <iframe src={project.map} width="100%" height="350" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="sticky top-24 bg-white border border-gray-100 rounded-2xl shadow-xl p-5 sm:p-7">
              ...
              <div className="mt-5 pt-5 border-t border-gray-100 space-y-3">
                <a href="tel:+919876543210" className="flex items-center gap-3 text-gray-700 hover:text-amber-600 transition text-sm">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                  +91 98765 43210
                </a>
                <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-green-600 transition text-sm">
